================================================================================
    MFC 라이브러리 : 0927_Ch05_ImageTool 프로젝트 개요
===============================================================================

응용 프로그램 마법사에서 이 0927_Ch05_ImageTool 응용 프로그램을 만들었습니다. 이 응용 프로그램은 MFC의 기본 사용법을 보여 줄 뿐만 아니라 응용 프로그램을 작성하기 위한 기본 구조를 제공합니다.

0927_Ch05_ImageTool 응용 프로그램을 구성하는 각 파일에 대한
요약 설명이 포함되어 있습니다.

0927_Ch05_ImageTool.vcxproj
...
0927_Ch05_ImageTool.vcxproj.filters
...
0927_Ch05_ImageTool.h
    해당 응용 프로그램의 기본 헤더 파일입니다.
    여기에는 resource.h를 비롯한 다른 프로젝트별 헤더가 포함되어 있으며 CMy0927_Ch05_ImageToolApp 응용 프로그램 클래스가 선언되어 있습니다.

0927_Ch05_ImageTool.cpp
    이는 응용 프로그램 클래스 CMy0927_Ch05_ImageToolApp가 포함된 기본 응용 프로그램 소스 파일입니다.

0927_Ch05_ImageTool.rc
...
res\0927_Ch05_ImageTool.ico
    아이콘 파일이며, 응용 프로그램의 아이콘으로 사용됩니다. 이 아이콘은 기본 리소스 파일인 0927_Ch05_ImageTool.rc에 의해 포함됩니다.

res\My0927_Ch05_ImageTool.rc2
    이 파일에는 Microsoft Visual C++ 이외의 다른 도구에서 편집한 리소스가 포함되어 있습니다. 리소스 편집기로 편집할 수 없는 모든 리소스는 이 파일에 넣어야 합니다.

0927_Ch05_ImageTool.reg
...
res\Toolbar.bmp
    ...
    초기 도구 모음과 상태 표시줄은 CMainFrame 클래스에서 생성됩니다. 이 도구 모음 비트맵을 리소스 편집기로 편집하고, 0927_Ch05_ImageTool.rc의 IDR_MAINFRAME TOOLBAR 배열을 업데이트하여 도구 모음 단추를 추가합니다.
/////////////////////////////////////////////////////////////////////////////
...
0927_Ch05_ImageToolDoc.h, 0927_Ch05_ImageToolDoc.cpp - 문서
    이 파일에는 CMy0927_Ch05_ImageToolDoc 클래스가 포함됩니다. 이 파일을 편집하여 특수 문서 데이터를 추가하고 CMy0927_Ch05_ImageToolDoc::Serialize를 통해 파일 저장 및 로드를 구현합니다.
    문서에는 다음과 같은 문자열이 있습니다.
        파일 확장명:      bmp
        파일 형식 ID:        My0927Ch05ImageTool.Document
        주 프레임 캡션:  0927_Ch05_ImageTool
        Doc 형식 이름:       My0927_Ch05_Ima
        필터 이름:         0927_Ch05_ImageTool Files (*.bmp)
        파일의 새 약식 이름: 0927_Ch05_Image
        파일 형식의 긴 이름: 0927_Ch05_ImageTool.Document

0927_Ch05_ImageToolView.h, 0927_Ch05_ImageToolView.cpp - 문서 뷰
    이 파일에는 CMy0927_Ch05_ImageToolView 클래스가 포함됩니다.
    CMy0927_Ch05_ImageToolView 개체는 CMy0927_Ch05_ImageToolDoc 개체를 보는 데 사용됩니다.

res\0927_Ch05_ImageToolDoc.ico
    아이콘 파일이며, CMy0927_Ch05_ImageToolDoc 클래스 MDII 자식 창의 아이콘으로 사용됩니다. 이 아이콘은 기본 리소스 파일인 0927_Ch05_ImageTool.rc에 의해 포함됩니다.
...
StdAfx.h, StdAfx.cpp
    이 파일은 미리 컴파일된 헤더(PCH) 파일 0927_Ch05_ImageTool.pch와 미리 컴파일된 형식(PCT) 파일 StdAfx.obj를 빌드하는 데 사용됩니다.

Resource.h
    새 리소스 ID를 정의하는 표준 헤더 파일입니다. Microsoft Visual C++에서 이 파일을 읽고 업데이트합니다.

0927_Ch05_ImageTool.manifest
