================================================================================
    MFC 라이브러리 : 1010_ImageTool 프로젝트 개요
================================================================================

응용 프로그램 마법사에서 이 1010_ImageTool 응용 프로그램을 
만들었습니다. 이 응용 프로그램은 MFC의 기본 사용법을 보여 줄 뿐만 아니라 응용 
프로그램작성을 위한 기본 구조를 제공합니다.

이 파일에는 1010_ImageTool 응용 프로그램을 구성하는 각 파일에 대한
요약 설명이 포함되어 있습니다.

1010_ImageTool.vcxproj
...
1010_ImageTool.vcxproj.filters
...
1010_ImageTool.h
    ...
    헤더(Resource.h 포함)가 들어 있고 CMy1010_ImageToolApp 응용 프로그램
    클래스를 선언합니다.

1010_ImageTool.cpp
    응용 프로그램 클래스 CMy1010_ImageToolApp이(가) 들어 있는 기본 응용 프로그램
    소스 파일입니다.
...
res\1010_ImageTool.ico
    응용 프로그램의 아이콘으로 사용되는 아이콘 파일입니다. 이 아이콘은
    주 리소스 파일인 1010_ImageTool.rc에 의해 포함됩니다.

res\My1010_ImageTool.rc2
...
1010_ImageToolDoc.h, 1010_ImageToolDoc.cpp - 문서
    이 파일에는 CMy1010_ImageToolDoc 클래스가 들어 있습니다. 이 파일을 편집하여
    특수한 문서 데이터를 추가하고 CMy1010_ImageToolDoc::Serialize를 통해 파일
    저장 및 로드를 구현합니다.
    이 문서에는 다음 문자열이 포함됩니다.
        파일 확장명:      bmp
        파일 형식 ID:        My1010ImageTool.Document
        주 프레임 캡션:  1010_ImageTool
        문서 형식 이름:       My1010_ImageToo
        필터 이름:         1010_ImageTool Files (*.bmp)
        파일의 새 약식 이름: 1010_ImageTool
        파일 형식의 긴 이름: 1010_ImageTool.Document

1010_ImageToolView.h, 1010_ImageToolView.cpp - 문서 뷰
    이 파일에는 CMy1010_ImageToolView 클래스가 들어 있습니다.
    CMy1010_ImageToolView 개체는 CMy1010_ImageToolDoc 개체를 보는 데 사용됩니다.

res\1010_ImageToolDoc.ico
    CMy1010_ImageToolDoc 클래스의 MDI 자식 창에 대한 아이콘으로 사용되는
    아이콘 파일입니다. 이 아이콘은 주 리소스 파일인 1010_ImageTool.rc에
    의해 포함됩니다.
...
StdAfx.h, StdAfx.cpp
    이 파일은 미리 컴파일된 헤더 파일(PCH)인 1010_ImageTool.pch와
