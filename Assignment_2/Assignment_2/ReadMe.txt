================================================================================
    MFC 라이브러리 : Assignment_2 프로젝트 개요
================================================================================

응용 프로그램 마법사에서 이 Assignment_2 응용 프로그램을 
만들었습니다. 이 응용 프로그램은 MFC의 기본 사용법을 보여 줄 뿐만 아니라 응용 
프로그램작성을 위한 기본 구조를 제공합니다.

이 파일에는 Assignment_2 응용 프로그램을 구성하는 각 파일에 대한
요약 설명이 포함되어 있습니다.
...
Assignment_2.h
    ...
    헤더(Resource.h 포함)가 들어 있고 CAssignment_2App 응용 프로그램
    클래스를 선언합니다.

Assignment_2.cpp
    응용 프로그램 클래스 CAssignment_2App이(가) 들어 있는 기본 응용 프로그램
    소스 파일입니다.
...
res\Assignment_2.ico
    응용 프로그램의 아이콘으로 사용되는 아이콘 파일입니다. 이 아이콘은
    주 리소스 파일인 Assignment_2.rc에 의해 포함됩니다.

res\Assignment_2.rc2
...
Assignment_2Doc.h, Assignment_2Doc.cpp - 문서
    이 파일에는 CAssignment_2Doc 클래스가 들어 있습니다. 이 파일을 편집하여
    특수한 문서 데이터를 추가하고 CAssignment_2Doc::Serialize를 통해 파일
    저장 및 로드를 구현합니다.
    이 문서에는 다음 문자열이 포함됩니다.
        파일 확장명:      bmp
        파일 형식 ID:        Assignment2.Document
        주 프레임 캡션:  Assignment_2
        문서 형식 이름:       Assignment_2
        필터 이름:         Assignment_2 Files (*.bmp)
        파일의 새 약식 이름: Assignment_2
        파일 형식의 긴 이름: Assignment_2.Document

Assignment_2View.h, Assignment_2View.cpp - 문서 뷰
    이 파일에는 CAssignment_2View 클래스가 들어 있습니다.
    CAssignment_2View 개체는 CAssignment_2Doc 개체를 보는 데 사용됩니다.

res\Assignment_2Doc.ico
    CAssignment_2Doc 클래스의 MDI 자식 창에 대한 아이콘으로 사용되는
    아이콘 파일입니다. 이 아이콘은 주 리소스 파일인 Assignment_2.rc에
    의해 포함됩니다.
...
StdAfx.h, StdAfx.cpp
    이 파일은 미리 컴파일된 헤더 파일(PCH)인 Assignment_2.pch와
