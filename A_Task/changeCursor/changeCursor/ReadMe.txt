...
changeCursorDoc.h, changeCursorDoc.cpp - 문서
    이 파일에는 CchangeCursorDoc 클래스가 들어 있습니다. 이 파일을 편집하여
    특수한 문서 데이터를 추가하고 CchangeCursorDoc::Serialize를 통해 파일
    저장 및 로드를 구현합니다.

changeCursorView.h, changeCursorView.cpp - 문서 뷰
    이 파일에는 CchangeCursorView 클래스가 들어 있습니다.
    CchangeCursorView 개체는 CchangeCursorDoc 개체를 보는 데 사용됩니다.

res\changeCursorDoc.ico
    CchangeCursorDoc 클래스의 MDI 자식 창에 대한 아이콘으로 사용되는
    아이콘 파일입니다. 이 아이콘은 주 리소스 파일인 changeCursor.rc에
    의해 포함됩니다.
