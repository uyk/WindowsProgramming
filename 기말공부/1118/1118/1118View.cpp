...
int CMy1118View::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	m_pushButton1.Create(_T("푸시버튼1"), WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON, CRect(20,20,160,50), this, 101);
	m_checkBox.Create(_T("체크박스"), WS_CHILD | WS_VISIBLE | BS_CHECKBOX , CRect(20,60,160,90), this, 102);
	m_3state.Create(_T("3상태 체크박스"), WS_CHILD | WS_VISIBLE | BS_AUTO3STATE, CRect(20,100,160,130), this, 103);
	...
	m_groupBox.Create(_T("그룹박스"), WS_CHILD | WS_VISIBLE | BS_GROUPBOX, CRect(10, 140, 170, 250), this, 106);
	m_pushButton2.Create(_T("푸시버튼2"), WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON, CRect(20,250,160,300), this, 107);
	m_pushButton3.Create(_T("푸시버튼3"), WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON, CRect(20,310,160,360), this, 108);
